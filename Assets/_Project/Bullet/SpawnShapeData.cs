...
public class SpawnShapeData
{
    ...
    public float groupRadius = 0.25f;
    ...
    [Range(0, 360f), Tooltip("The arc of the spawn shape (in degrees).")]
    public float arc = 360f;

    [Range(0, 360f), Tooltip("The possible directions for the randomised direction mode")]
    public float directionArc = 360f;
    ...
    private void SpawnGroup(Vector2 position, Vector2 direction, Action<Vector2, Vector2> onGetPoint)
    {
        ...
        for (int i = 0; i < numPerGroup; i++)
        {
            ...
            Vector2 pos = Quaternion.LookRotation(Vector3.forward, direction) *
                          new Vector2(Mathf.Cos(angle), Mathf.Sin(angle)) * groupRadius;
    ...
    private void SpawnLine(Action<Vector2, Vector2> onGetPoint)
    {
    ...
    public void Spawn(Action<Vector2, Vector2> onGetPoint)
    {
        ...
        for (int i = 0; i < numPoints; i++)
        {
            ...
            {
                var rndAngle = directionArc * Mathf.Deg2Rad;
